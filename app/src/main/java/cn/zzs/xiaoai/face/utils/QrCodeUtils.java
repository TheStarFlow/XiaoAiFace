package cn.zzs.xiaoai.face.utils;
...
public class QrCodeUtils {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int width, int height,String char_set) {
        return createQRCodeBitmap(content, width, height, char_set, "H", "2", Color.BLACK, Color.WHITE);
    }
